#Exercício 2 - Por Gabriel Ramires e Rafael Mattia

.data
a: .word 40                           # 0x10010000
b: .word 3                            # 0x10010004
c: .word 3                            # 0x10010008
.text

	# Acessando os dados da memória a partir do Label e colocando nos registradores t0-t2
